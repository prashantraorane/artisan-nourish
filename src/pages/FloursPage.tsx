...
import { getProductsByCategory, getFlourTypes } from '@/lib/products';
...
const FloursPage = () => {
  ...
  const types = getFlourTypes();
  const allProducts = getProductsByCategory('flour').map(p => ({
    ...p,
    ...
    <div className="animate-fade-in">
      ...
      <section className="relative h-64 md:h-80 flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <img src={heroImage} alt="Flours" className="w-full h-full object-cover" />
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <p className="text-primary-foreground/80 max-w-2xl mx-auto">
            Premium quality flours for all your baking needs, from gluten-free to whole grain options
          </p>
        </div>
      </section>
